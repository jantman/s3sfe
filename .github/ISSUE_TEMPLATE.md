...
s3sfe version, as reported by ``s3sfe --version``

### Installation Method

How was s3sfe installed (provide as much detail as possible, ideally
...
that s3sfe is running in, as well as your operating system type and version.

### Actual Output

```
Paste here the output of s3sfe (including the command used to run it),
