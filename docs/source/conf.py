# -*- coding: utf-8 -*-
#
# s3sfe documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 's3sfe.tex', u's3sfe Documentation',
...
man_pages = [
    (master_doc, 's3sfe', u's3sfe Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 's3sfe', u's3sfe Documentation',
   author, 's3sfe', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/s3sfe'
]
